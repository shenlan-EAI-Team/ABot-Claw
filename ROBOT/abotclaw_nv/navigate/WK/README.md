...
cd /home/unitree/abotclaw_nv/unitree_sdk2_python
pip3 install -e .
...
rosrun map_server map_saver map:=/projected_map -f /home/unitree/navigate/map/mymap
```
...
#若在机器人端可以使用vnc可视化连接
sshpass -p '123' ssh -o StrictHostKeyChecking=no unitree@192.168.123.164 'vncserver :1 -geometry 1920x1080 -depth 24 -localhost no'
```

如果使用docker，请在宿主机上使用rviz查看
